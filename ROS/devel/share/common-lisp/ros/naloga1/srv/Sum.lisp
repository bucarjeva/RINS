...
(cl:defmethod cl:initialize-instance :after ((m <Sum-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Sum-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name naloga1-srv:<Sum-request> is deprecated: use naloga1-srv:Sum-request instead.")))

(cl:ensure-generic-function 'nums-val :lambda-list '(m))
(cl:defmethod nums-val ((m <Sum-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader naloga1-srv:nums-val is deprecated.  Use naloga1-srv:nums instead.")
  (nums m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Sum-request>)))
  ...
  "703b51aee7a7c5741886072d7be5fc8e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Sum-request)))
  "Returns md5sum for a message object of type 'Sum-request"
  "703b51aee7a7c5741886072d7be5fc8e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Sum-request>)))
  ...
  (cl:format cl:nil "#request~%int32[] nums~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Sum-request)))
  "Returns full string definition for message of type 'Sum-request"
  (cl:format cl:nil "#request~%int32[] nums~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <Sum-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Sum-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name naloga1-srv:<Sum-response> is deprecated: use naloga1-srv:Sum-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <Sum-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader naloga1-srv:result-val is deprecated.  Use naloga1-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Sum-response>)))
  ...
  (cl:format cl:nil "#response~%int32 result~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Sum-response)))
  "Returns full string definition for message of type 'Sum-response"
  (cl:format cl:nil "#response~%int32 result~%~%~%~%"))
